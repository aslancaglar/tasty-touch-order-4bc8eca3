  ...
  return (
    <div className="fixed inset-0 flex flex-col items-center justify-center bg-cover bg-center" style={{
      ...
      <div>
        <Button 
          onClick={onStart} 
          className="shadow-lg animate-pulse bg-violet-700 hover:bg-violet-600 text-slate-50 md:text-6xl lg:text-7xl px-12 md:px-[40px] md:py-[70px] lg:px-[60px] lg:py-[90px] font-bebas tracking-wide py-[91px] rounded-full text-xl text-center"
        >
          {t("welcome.start")}
        </Button>
      </div>
