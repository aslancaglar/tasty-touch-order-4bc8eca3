  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4">
        ...
        {/* Language selection prompt (more prominent) */}
        <div className="text-center mb-12">
          <p className="text-white/90 text-lg md:text-xl lg:text-2xl mb-4 font-inter">
            {t("welcome.selectLanguage") || "Choose your language / Choisissez votre langue / Dilinizi seçin"}
          </p>
