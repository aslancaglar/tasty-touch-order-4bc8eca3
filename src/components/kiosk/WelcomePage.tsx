...
const WelcomePage = ({
  ...
  return (
    <div className="fixed inset-0 flex flex-col items-center bg-cover bg-center" 
      style={{
    ...
    >
      ...
      <div className="text-center px-4 mt-16">
        ...
        <p className="text-white text-xl md:text-2xl lg:text-5xl font-inter">
          {t("welcome.title")}
        </p>
      </div>
      
      {/* Middle section with start button - positioned with margin-top:auto and margin-bottom:auto */}
      <div className="flex-grow flex items-center justify-center my-auto">
        <Button 
          onClick={onStart} 
          className="shadow-lg animate-pulse bg-violet-700 hover:bg-violet-600 text-slate-50 md:text-6xl lg:text-7xl px-12 md:px-[40px] md:py-[70px] lg:px-[60px] lg:py-[90px] font-bebas tracking-wide py-[91px] rounded-full text-xl"
        >
          {t("welcome.start")}
        </Button>
      </div>
