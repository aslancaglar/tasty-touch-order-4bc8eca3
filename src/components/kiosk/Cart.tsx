...
import { Check, ArrowRight, Loader2, Plus, Minus, Trash2, ChevronDown, X, ChevronUp } from "lucide-react";
...
const Cart: React.FC<CartProps> = ({
  ...
  return (
    <>
      <div className="fixed bottom-0 left-0 right-0 z-30 bg-white border-t border-gray-200 shadow-lg" style={{ maxHeight: collapsed ? "64px" : "50vh" }}>
