...
export function NetworkStatus({
  ...
  const getTooltipText = () => {
    ...
    if (isFromCache) {
      return lastUpdated ? `Showing cached data from ${lastUpdated.toLocaleString()}` : "Showing cached data";
    }
  ...
  return <>
      {showBanner && <Alert variant="destructive" className="fixed top-4 right-4 left-4 md:left-auto z-50 shadow-lg max-w-md">
