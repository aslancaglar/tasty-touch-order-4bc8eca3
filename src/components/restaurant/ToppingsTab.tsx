    ...
    <div className="space-y-6">
      ...
      <Dialog open={showUpdateToppingDialog} onOpenChange={setShowUpdateToppingDialog}>
        <DialogContent>
          ...
          name_de: selectedTopping.name_de,
          name_es: selectedTopping.name_es,
          name_it: selectedTopping.name_it,
          name_nl: selectedTopping.name_nl,
          name_pt: selectedTopping.name_pt,
          name_ru: selectedTopping.name_ru,
          name_ar: selectedTopping.name_ar,
          name_zh: selectedTopping.name_zh,
