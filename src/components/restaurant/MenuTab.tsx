  ...
  const handleAddCategory = async (values: any) => {
    try {
      ...
      const newCategory = await createCategory({
        ...
        name_de: values.name_de || null,
        name_es: values.name_es || null,
        name_it: values.name_it || null,
        name_nl: values.name_nl || null,
        name_pt: values.name_pt || null,
        name_ru: values.name_ru || null,
        name_ar: values.name_ar || null,
        name_zh: values.name_zh || null,
        ...
        description_nl: values.description_nl || null,
        description_pt: values.description_pt || null,
        description_ru: values.description_ru || null,
        description_ar: values.description_ar || null,
        description_zh: values.description_zh || null,
          ...
          {selectedItem && (
            <MenuItemForm
              ...
              initialValues={{
                ...
                name_de: selectedItem.name_de || "",
                name_es: selectedItem.name_es || "",
                name_it: selectedItem.name_it || "",
                name_nl: selectedItem.name_nl || "",
                name_pt: selectedItem.name_pt || "",
                name_ru: selectedItem.name_ru || "",
                name_ar: selectedItem.name_ar || "",
                name_zh: selectedItem.name_zh || "",
                ...
                description_de: selectedItem.description_de || "",
                description_es: selectedItem.description_es || "",
                description_it: selectedItem.description_it || "",
                description_nl: selectedItem.description_nl || "",
                description_pt: selectedItem.description_pt || "",
                description_ru: selectedItem.description_ru || "",
                description_ar: selectedItem.description_ar || "",
                description_zh: selectedItem.description_zh || "",
