...
const ToppingCategoryForm = ({
  ...
  const [descriptionValues, setDescriptionValues] = useState({
    ...
    de: initialValues?.description_de || "",
    es: initialValues?.description_es || "",
    it: initialValues?.description_it || "",
    nl: initialValues?.description_nl || "",
    pt: initialValues?.description_pt || "",
    ru: initialValues?.description_ru || "",
    ar: initialValues?.description_ar || "",
    zh: initialValues?.description_zh || ""
  });
